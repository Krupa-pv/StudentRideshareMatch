        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-center gap-4 mb-8">
                <button
                    ...
                    className={`px-6 py-3 border-2 border-black font-medium transition-colors ${showCreateForm ? 'bg-black text-white' : 'hover:bg-gray-100'
                        }`}
                >
                    Create New Group
                </button>
                <button
                    ...
                    className={`px-6 py-3 border-2 border-black font-medium transition-colors ${showJoinForm ? 'bg-black text-white' : 'hover:bg-gray-100'
                        }`}
                >
                    Join/Leave Group
                </button>
                        ...
                        <div className="max-h-96 overflow-y-auto">
                            {groups.map((group) => (
                                <div
                                    ...
                                    className={`p-4 border-b border-gray-300 cursor-pointer hover:bg-gray-50 ${selectedGroup?.group_id === group.group_id ? 'bg-gray-100' : ''
                                        }`}
                                >
